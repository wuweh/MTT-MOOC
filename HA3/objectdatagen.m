...
%        ifnoisy: boolean value indicating whether to generate noisy object state sequence or not
%OUTPUT: objectdata.X:  (K x 1) cell array, each cell stores object states of size (object state dimension) x (number of objects at corresponding time step)
%        objectdata.N:  (K x 1) cell array, each cell stores the number of objects at corresponding time step
