classdef hypothesisReduction
    ...
    methods (Static)
        function [hypothesesWeight_hat, multiHypotheses_hat] = prune(hypothesesWeight, multiHypotheses, threshold)
            ...
            %INPUT: hypothesesWeight: the weights of different hypotheses in logarithm domain --- (number of hypotheses) x 1 vector
            ...
            %OUTPUT:hypothesesWeight_update: hypotheses weights after pruning in logarithm domain --- (number of hypotheses after pruning) x 1 vector
        ...
        function [hypothesesWeight_hat,multiHypotheses_hat] = merge(hypothesesWeight,multiHypotheses,threshold,density)
            ...
            %OUTPUT:hypothesesWeightMerged: hypotheses weights after merging in logarithm domain --- (number of hypotheses after merging) x 1 vector
