...
NN_estimated_state = cell2mat((nearestNeighborEstimates.x)');
PDA_estimated_state = cell2mat((probDataAssocEstimates.x'));
MH_estimated_state = cell2mat((multiHypothesesEstimates.x'));
